package by.iba.ionanova.command.factory;

import by.iba.ionanova.command.*;
import by.iba.ionanova.command.authorization.RegisterNewUserCommand;
import by.iba.ionanova.command.grouppersons.AddNewPersonCommand;
import by.iba.ionanova.command.grouppersons.WelcomeCommand;
